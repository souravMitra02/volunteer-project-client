  ...
  return (
    <section className="max-w-3xl mx-auto px-4 py-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <input type="text" name="postTitle" placeholder="Post Title" required className="input input-bordered w-full" />
        ...
        <input type="number" name="volunteersNeeded" placeholder="No. of Volunteers Needed" required className="input input-bordered w-full" />
        ...
        <button type="submit" className="btn bg-green-600 text-white hover:bg-green-700 w-full">Add Post</button>
      </form>
    </section>
  );
};
